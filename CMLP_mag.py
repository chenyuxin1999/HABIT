...
g = np.load('G_mag.npy',allow_pickle=True)
W = np.load('W_mag.npy',allow_pickle=True)
D = np.load('D_mag.npy',allow_pickle=True)
...
for i in range(1000):
    ...
    writer.add_scalar('f1_score_micro_mag', f1_micro, i)
    writer.add_scalar('f1_score_macro_mag', f1_macro, i)
    writer.add_scalar('f1_example_mag', f1_example, i)
    writer.add_scalar('ranking_loss_mag', rankingloss, i)
