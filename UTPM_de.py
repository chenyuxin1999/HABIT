...
def train():
    ...
    for epoch in range(end_epoch):
        ...
        rankingloss = rankingloss / 3

        writer.add_scalar('f1_score_micro_UTPM_delicious', f1_micro, epoch)
        writer.add_scalar('f1_score_macro_UTPM_delicious', f1_macro, epoch)
        writer.add_scalar('f1_example_UTPM_delicious', f1_example, epoch)
        writer.add_scalar('ranking_loss_UTPM_delicious', rankingloss, epoch)
